...
<?php
	...
	if(isset($_GET['year']) && isset($_GET['cons']) && isset($_GET['name']) && isset($_GET['party'])){
		$year = $_GET['year'];
		$cons = $_GET['cons'];
		$cand = $_GET['name'];
		$party = $_GET['party'];
	...
	$query = "SELECT * FROM all_ls WHERE year='$year' and constituency='$cons' and candidate='$cand' and party='$party'"; 
